  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        {/* Selection Progress */}
        <div className="fixed bottom-6 right-6 bg-white rounded-xl shadow-lg border border-slate-200 p-4 max-w-xs hidden md:block">
...
export default MentorshipBusinessCase;
