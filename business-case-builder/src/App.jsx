...
function App() {
  ...
  // Show progress tracker after scrolling past the header
  useEffect(() => {
    const handleScroll = () => {
      setShowProgressTracker(window.scrollY > 400);
    };
  ...
  const handleSubmit = (e) => {
    ...
    if (selections.email && selections.email.includes("@")) {
      ...
      console.log("Submission data:", selections);
    }
  };

  const completedSelections = [
    selections.primaryGoal,
    selections.programType,
    selections.audienceSize,
    selections.matchingApproach,
    selections.measurementFocus,
    selections.timeline,
  ].filter(Boolean).length;

  const SelectionCard = ({ field, value, label, description, selected }) => (
    <button
      type="button"
            ...
            <div className="space-y-4 bg-slate-50 rounded-xl p-6">
              <div className="flex justify-between py-2 border-b border-slate-200">
                ...
                <span className="font-semibold text-slate-800">
                  {selections.primaryGoal || "Not selected"}
                </span>
              </div>
              <div className="flex justify-between py-2 border-b border-slate-200">
                <span className="text-slate-600">Program Type</span>
                <span className="font-semibold text-slate-800">
                  {selections.programType || "Not selected"}
                </span>
              </div>
              <div className="flex justify-between py-2 border-b border-slate-200">
                <span className="text-slate-600">Audience Size</span>
                <span className="font-semibold text-slate-800">
                  {selections.audienceSize || "Not selected"}
                </span>
              </div>
              <div className="flex justify-between py-2 border-b border-slate-200">
                <span className="text-slate-600">Matching Approach</span>
                <span className="font-semibold text-slate-800">
                  {selections.matchingApproach || "Not selected"}
                </span>
              </div>
              <div className="flex justify-between py-2 border-b border-slate-200">
                <span className="text-slate-600">Measurement Focus</span>
                <span className="font-semibold text-slate-800">
                  {selections.measurementFocus || "Not selected"}
                </span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-slate-600">Timeline</span>
                <span className="font-semibold text-slate-800">
                  {selections.timeline || "Not selected"}
                </span>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-slate-100 rounded-xl p-6 my-6 font-mono text-sm not-prose">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 my-8 shadow-sm">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            ...
            <SelectionCard
              ...
              selected={
                selections.measurementFocus === "Engagement & Satisfaction"
              }
            />
            <SelectionCard
              field="measurementFocus"
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 my-12 text-white">
          ...
          <blockquote className="text-slate-400 text-sm italic border-l-2 border-emerald-500 pl-4">
        ...
        <div className="bg-white rounded-2xl border-2 border-emerald-200 p-8 my-12">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-6 pt-6 border-t border-slate-200">
      ...
      <div
        className={`fixed bottom-6 right-6 bg-white rounded-xl shadow-lg border border-slate-200 p-4 max-w-xs transition-all duration-300 hidden md:block ${
          showProgressTracker
        ...
        <div className="mt-3 pt-3 border-t border-slate-100">
          <div className="w-full bg-slate-100 rounded-full h-2">
            <div
              ...
              style={{
                width: `${(completedSelections / 6) * 100}%`,
              }}
            ></div>
          </div>
          <p className="text-xs text-slate-400 mt-2 text-center">
            {completedSelections}/6 complete
          </p>
        </div>
      </div>
